...
exports.HolidaySlzController = void 0;
const AppError_1 = require("@/utils/AppError");
const knex_1 = require("@/database/knex");
const zod_1 = require("zod");
class HolidaySlzController {
    async index(request, response, next) {
        try {
            const holidays = await (0, knex_1.knex)("holidays_slz")
    ...
    async create(request, response, next) {
        try {
            ...
            await (0, knex_1.knex)("holidays_slz").insert({ holiday_name, day, month, optional });
    ...
    async delete(request, response, next) {
        try {
            ...
            const holiday = await (0, knex_1.knex)("holidays_slz")
                .select()
                .where({ id })
                .first();
            if (!holiday) {
            ...
            await (0, knex_1.knex)("holidays_the").delete().where({ id });
...
exports.HolidaySlzController = HolidaySlzController;
//# sourceMappingURL=holidays-slz-controller.js.map