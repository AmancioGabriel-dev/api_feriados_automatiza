...
exports.HolidayTheController = void 0;
const AppError_1 = require("@/utils/AppError");
const knex_1 = require("@/database/knex");
const zod_1 = require("zod");
class HolidayTheController {
    async index(request, response, next) {
        try {
            const holidays = await (0, knex_1.knex)("holidays_the")
    ...
    async create(request, response, next) {
        try {
            ...
            await (0, knex_1.knex)("holidays_the").insert({ holiday_name, day, month, optional });
    ...
    async delete(request, response, next) {
        try {
            ...
            const holiday = await (0, knex_1.knex)("holidays_the")
                .select()
                .where({ id })
                .first();
            if (!holiday) {
...
exports.HolidayTheController = HolidayTheController;
//# sourceMappingURL=holidays-the-controller.js.map